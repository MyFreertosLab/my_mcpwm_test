...
// https://www.instructables.com/The-Incredible-ESP32-Wrover-From-Espressif/

#define GPIO_PWM0A_OUT 19   //Set GPIO 19 as PWM0A
#define GPIO_PWM0B_OUT 18   //Set GPIO 18 as PWM0B
#define GPIO_PWM1A_OUT 13   //Set GPIO 17 as PWM1A
#define GPIO_PWM1B_OUT 27   //Set GPIO 27 as PWM1B
...
static void mcpwm_example_config(void *arg)
{
    ...
    pwm_config.frequency = 490;
    pwm_config.cmpr_a = 50.0;
    pwm_config.cmpr_b = 98.0;
    pwm_config.counter_mode = MCPWM_UP_COUNTER;
    pwm_config.duty_mode = MCPWM_DUTY_MODE_0;
    mcpwm_init(MCPWM_UNIT_0, MCPWM_TIMER_0, &pwm_config);
    pwm_config.frequency = 490;
    pwm_config.cmpr_a = 50.0;
    pwm_config.cmpr_b = 55.0;
    pwm_config.counter_mode = MCPWM_UP_COUNTER;
    pwm_config.duty_mode = MCPWM_DUTY_MODE_0;
    ...
    MCPWM[MCPWM_UNIT_0]->cap_cfg_ch[0].prescale = 141;
